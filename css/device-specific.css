...
<body>
    ...
    <script>
        ...
        async function syncCompletedDataFromServer() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    console.log('[DEBUG] Server returned user data:', {
                        xp: result.xp,
                        level: result.level,
                    ...
                    if (result.completed_levels && Array.isArray(result.completed_levels)) {
                        ...
                        console.log('[DEBUG] Updated local completedLevels with server data:', mergedLevels);
                    }
                    
                    // IMPORTANT FIX: Prioritize server completed_exams data over local storage
                    if (result.completed_exams && Array.isArray(result.completed_exams)) {
                        ...
                        console.log('[DEBUG] Merged completedExams:', {
                            fromServer: result.completed_exams,
                            fromLocal: localExams, 
                            merged: mergedExams
                        });
                    }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // First render with 0 XP to show something immediately
                    ...
                    .then(data => {
                        ...
                        if (data && typeof data.xp !== 'undefined') {
                            ...
                            if (data.completed_exams && Array.isArray(data.completed_exams)) {
                                ...
                                localStorage.setItem('completedExams', JSON.stringify(mergedExams));
                                console.log('[DEBUG] Updated localStorage completedExams from server:', {
